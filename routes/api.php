...
Route::middleware(['APISwitchDatabase'])->group(function () {
...
Route::group(['prefix' => 'student'], static function () {
    ...
    Route::post('login', [StudentApiController::class, 'login'])->middleware('throttle:5,1');
...
Route::group(['prefix' => 'teacher'], static function () {
    //Non Authenticated APIs
    Route::post('login', [TeacherApiController::class, 'login'])->middleware('throttle:5,1');
    //Authenticated APIs
    Route::group(['middleware' => ['APISwitchDatabase', 'checkSchoolStatus']], static function () {
...
// Receipt preview - auth required
Route::get('/receipt-preview', [ParentApiController::class, 'feesPaidReceiptPreview'])
    ->middleware(['APISwitchDatabase']);
