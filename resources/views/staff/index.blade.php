                        ...
                        <form class="pt-3 create-staff-form" id="create-form" action="{{ route('staff.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="hidden" name="image_cropped" id="staff_create_image_cropped">
                                    <input type="file" id="staff_create_image_input" class="d-none" accept="image/png,image/jpeg,image/jpg"/>
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled=""
                                            placeholder="{{ __('image') }}" id="staff_create_image_info" />
                                        <span class="input-group-append">
                                            <button class="btn btn-theme" type="button" onclick="document.getElementById('staff_create_image_input').click()">{{ __('upload') }}</button>
                                        </span>
                                    </div>
                                    <div id="staff_create_preview" class="d-none mt-1" style="width:60px;">
                                            ...
                                            <div data-repeater-list="allowance_data">
                                                <div class="row allowance_type_div" id="allowance_type_div"
                                                    ...
                                                    <div class="form-group col-xl-4" id="amount_allowance_div"
                                                        ...
                                                        <input type="text" id="allowance_amount"
                                                            name="allowance[0][amount]" class="allowance_amount form-control"
                                                    ...
                                                    <div class="form-group col-xl-4" id="percentage_allowance_div"
                                                        ...
                                                        <input type="text" id="allowance_percentage"
                                                            ...
                                                            class="allowance_percentage form-control" min="0.1"
                                                            max="100" placeholder="{{ __('percentage') }}" required>
                                                    </div>
                                                ...
                                                <div class="row deduction_type_div" id="deduction_type_div"
                                                    ...
                                                    <div class="form-group col-xl-4" id="amount_deduction_div"
                                                        ...
                                                        <input type="text" id="deduction_amount"
                                                            name="deduction[0][amount]" class="deduction_amount form-control"
                                                            placeholder="{{ __('amount') }}" min="1" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-xl-4" id="percentage_deduction_div"
                                                        ...
                                                        <input type="text" id="deduction_percentage"
                                                            ...
                                                            class="deduction_percentage form-control" min="0.1"
                                                            max="100" placeholder="{{ __('percentage') }}" required>
                                                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                            ...
                            data-export-options='{ "fileName": "staff-list-<?= date('d-m-y') ?>"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="roles_name" data-sortable="false">{{ __('role') }}
                                    </th>
                                    ...
                                    @if (!Auth::user()->school_id)
                                        <th scope="col" data-field="support_school"
                                            data-formatter="schoolNameFormatter">{{ __('assign_schools') }}</th>
                                    @endif
                                    ...
                                    <th scope="col" data-field="operate" data-events="staffEvents"
                        ...
                        <form class="pt-3 edit-staff-form" id="edit-form" action="{{ url('staff') }}"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="edit_email">{{ __('email') }} <span
                                                class="text-danger"></span></label>
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label>{{ __('image') }} <span
                                                class="text-info text-small">(308px*338px)</span></label>
                                        <input type="hidden" name="image_cropped" id="staff_edit_image_cropped">
                                        <input type="file" id="staff_edit_image_input" class="d-none" accept="image/png,image/jpeg,image/jpg"/>
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" disabled=""
                                                placeholder="{{ __('image') }}" id="staff_edit_image_info" />
                                            <span class="input-group-append">
                                                <button class="btn btn-theme" type="button" onclick="document.getElementById('staff_edit_image_input').click()">{{ __('upload') }}</button>
                                            </span>
                                        </div>
                                            ...
                                            @foreach ($extraFields as $key => $data)
                                                ...
                                                <div class='form-group col-md-12 col-lg-6 col-xl-4 col-sm-12'>
                                                    ...
                                                    @elseif($data->type == 'number')
                                                        ...
                                                        {{-- Dropdown Field --}}
                                                    @elseif($data->type == 'dropdown')
                                                        {{ Form::select('edit_extra_fields[' . $key . '][data]', $data->default_values, null, [
                                                            'id' => 'edit_' . $fieldName,
                                                            'class' => 'form-control select-fields',
                                                            $data->is_required == 1 ? 'required' : '',
                                                            'placeholder' => 'Select ' . $data->name,
                                                    ...
                                                    @elseif($data->type == 'file')
                                                        ...
                                                        <div id="edit_file_div_{{ $fieldName }}"
                                        ...
                                        <div class="form-check w-fit-content">
                                            <label class="form-check-label ml-4">
                                                <input type="checkbox" class="form-check-input"
                                                    id="two_factor_verification" name="two_factor_verification"
...
@section('script')
    ...
    {{-- Crop Modal --}}
    <div class="modal" id="staffCropModal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index:1060;display:none;">
        <div class="modal-dialog" role="document" style="max-width:480px;">
            <div class="modal-content">
                <div class="modal-header py-2">
                    <h6 class="modal-title">Crop Image</h6>
                    <button type="button" class="close" id="staffCropClose" aria-label="Close"><span>&times;</span></button>
                </div>
                <div class="modal-body p-2 text-center">
                    <img id="staff_crop_preview" src="" style="max-width:100%;max-height:320px;display:block;" alt="crop">
                </div>
                <div class="modal-footer py-2">
                    <button type="button" class="btn btn-secondary btn-sm" id="staffCropClose2">{{ __('Cancel') }}</button>
                    <button type="button" class="btn btn-theme btn-sm" id="staffCropDone">Crop & Use</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        let userIds;
        let staffCropper = null, staffCropTarget = null;

        function openStaffCrop(file, target) {
            staffCropTarget = target;
            const reader = new FileReader();
            reader.onload = function(e) {
                const img = document.getElementById('staff_crop_preview');
                img.src = e.target.result;
                if (staffCropper) { staffCropper.destroy(); staffCropper = null; }
                $('#staffCropModal').modal('show');
                $('#staffCropModal').one('shown.bs.modal', function() {
                    staffCropper = new Cropper(img, { aspectRatio: 308/338, viewMode: 1, autoCropArea: 1, minContainerHeight: 280, maxContainerHeight: 320 });
                });
            };
        ...
        $(document).ready(function() {
            $('#staff_create_image_input').on('change', function() {
                if (this.files && this.files[0]) openStaffCrop(this.files[0], 'create');
            });
            $('#staff_edit_image_input').on('change', function() {
                if (this.files && this.files[0]) openStaffCrop(this.files[0], 'edit');
            });
            $('#staffCropDone').on('click', function() {
                if (!staffCropper) return;
                const dataUrl = staffCropper.getCroppedCanvas({ width: 308, height: 338 }).toDataURL('image/jpeg', 0.9);
                if (staffCropTarget === 'create') {
                    $('#staff_create_image_cropped').val(dataUrl);
                    $('#staff_create_image_info').val('image_cropped.jpg');
                    $('#staff_create_preview').removeClass('d-none').find('img').attr('src', dataUrl);
                } else {
                    $('#staff_edit_image_cropped').val(dataUrl);
                    $('#staff_edit_image_info').val('image_cropped.jpg');
                    $('#edit_staff_image').attr('src', dataUrl);
                }
                staffCropper.destroy(); staffCropper = null;
                $('#staffCropModal').modal('hide');
                if (staffCropTarget === 'create') $('#staff_create_image_input').val('');
                else $('#staff_edit_image_input').val('');
            });
            $('#staffCropClose, #staffCropClose2').on('click', function() {
                if (staffCropper) { staffCropper.destroy(); staffCropper = null; }
                $('#staffCropModal').modal('hide');
                if (staffCropTarget === 'create') $('#staff_create_image_input').val('');
                else $('#staff_edit_image_input').val('');
            });
            $('#staffCropModal').on('hidden.bs.modal', function() {
                if (staffCropTarget === 'edit' && $('#editModal').hasClass('show')) {
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addAllowanceButton.addEventListener('click', function() {
                const newItem = allowanceDataContainer.querySelector('[data-repeater-item]').cloneNode(
                true);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addDeductionButton.addEventListener('click', function() {
                const newItem = deductionDataContainer.querySelector('[data-repeater-item]').cloneNode(
                true);
