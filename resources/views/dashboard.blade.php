    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                <span class="page-title-icon bg-theme text-white mr-2">
                    <svg width="22" height="22" class="mt-2" viewBox="0 0 22 22" fill="none"
                        ...
                        <g id="vuesax/linear/grid-6">
                            <g id="vuesax/linear/grid-6_2">
                                <g id="grid-6">
                                    ...
                                    <path id="Vector_2" d="M9.16667 1.83337V20.1667" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path id="Vector_3" d="M9.16667 7.79163H20.1667" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path id="Vector_4" d="M9.16667 14.2084H20.1667" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                            </g>
                        </g>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="alert alert-danger" role="alert">
                                ...
                                @if ($prepiad_upcoming_plan && $prepiad_upcoming_plan->package->type == 0 && !$check_payment)
                                    ...
                                    @else
                                        <form action="{{ url('subscriptions/razorpay') }}" class="razorpay-form"
                                            method="POST">
                                            @csrf
                                            ...
                                            <input type="hidden" name="razorpay_signature" class="razorpay_signature"
                                                value="">
                                            <input type="hidden" name="razorpay_order_id" class="razorpay_order_id"
                                                value="">

                                            <input type="hidden" name="paymentTransactionId" class="paymentTransactionId"
                                                value="">

                                            <input type="hidden" name="subscription_id" class="subscription_id"
                                                value="{{ $prepiad_upcoming_plan->id }}">
                                            <input type="hidden" name="upcoming_plan_type"
                                                value="{{ $prepiad_upcoming_plan_type }}">
                            ...
                            <div class="card-body custom-card-body">
                                <div class="d-flex flex-row flex-wrap">
                                    ...
                                    <span class="icon-card-teacher">
                                        <img src="{{ url('assets/icons/school-dashboard-icons/teacher.svg') }}"
                                            alt="teacher">
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="card-body custom-card-body">
                                <div class="d-flex flex-row flex-wrap">
                                    ...
                                    <span class="icon-card-active">
                                        <img src="{{ url('assets/icons/school-dashboard-icons/students.svg') }}"
                                            alt="teacher">
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="card-body custom-card-body">
                                <div class="d-flex flex-row flex-wrap">
                                    ...
                                    <span class="icon-card-inactive">
                                        <img src="{{ url('assets/icons/school-dashboard-icons/guardians.svg') }}"
                                            alt="teacher">
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="card-body custom-card-body">
                                <div class="d-flex flex-row flex-wrap">
                                    ...
                                    <span class="icon-card-package">
                                        <img src="{{ url('assets/icons/school-dashboard-icons/classes.svg') }}"
                                            alt="teacher">
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="card-body custom-card-body">
                                <div class="d-flex flex-row flex-wrap">
                                    ...
                                    <span class="icon-card-screams">
                                        <img src="{{ url('assets/icons/school-dashboard-icons/screams.svg') }}"
                                            alt="teacher">
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body custom-card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    {!! Form::select('class_id', count($class_names) > 0 ? $class_names : ['' => 'Not Data Available'], null, [
                                ...
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="title" class="truncateTitle">
                                                {{ __('title') }}</th>
                    ...
                    <div class="card">
                        <div class="card-body custom-card-body">
                            <div class="row">
                                <div class="col-md-7">
                                    <h3 class="card-title">
                                        {{ __('fees_over_due') }} <span class="ml-2"><i
        ...
        @if (Auth::user()->hasRole('Super Admin') || !Auth::user()->school_id)
                        ...
                        <div class="card-body custom-card-body">
                            <div class="d-flex flex-row flex-wrap">
                                ...
                                <span class="icon-card-school">
                                    <img src="{{ url('assets/icons/dashboard-icons/total-schools.svg') }}"
                                        alt="total Schools">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body custom-card-body">
                            <div class="d-flex flex-row flex-wrap">
                                ...
                                <span class="icon-card-active">
                                    <img src="{{ url('assets/icons/dashboard-icons/active-schools.svg') }}"
                                        alt="Active Schools">
                                </span>
                    ...
                    <div class="card">
                        <div class="card-body custom-card-body">
                            <div class="d-flex flex-row flex-wrap">
                                ...
                                <span class="icon-card-inactive">
                                    <img src="{{ url('assets/icons/dashboard-icons/inactive-schools.svg') }}"
                                        alt="Active Schools">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body custom-card-body">
                            <div class="d-flex flex-row flex-wrap">
                                ...
                                <span class="icon-card-package">
                                    <img src="{{ url('assets/icons/dashboard-icons/packages.svg') }}"
                                        alt="package Schools">
                                </span>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                @if (
                    ($settings['database_root_user'] ?? 0) == 0 ||
                        ($settings['laravel_queue_setup'] ?? 0) == 0 ||
                        ($settings['wildcard_domain'] ?? 0) == 0 ||
                        ($settings['web_socket_setup'] ?? 0) == 0 ||
                        ($settings['notification_settings'] ?? 0) == 0)
                                                ...
                                                <li class="{{ $loop->index == 0 ? 'border-bottom' : '' }}">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="checkbox server-configuration-checkbox"
                                                                id="{{ $key }}" value="1" type="checkbox">
                                                            {{ $value['title'] }} <i class="input-helper"></i>
                                                            <a href="{{ $value['link'] }}" target="_blank"
                                                                class="">
                                                                {{ __('view_setup') }}
                                                            </a>
                                                        </label>
                                                        <p class="text-muted text-wrap">{{ $value['description'] ?? '' }}
                                                        </p>
                                                    </div>
                                                </li>
                                            @endif
