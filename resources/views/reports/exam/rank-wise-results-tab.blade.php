                ...
                <div class="card-body px-0">
                    <div class="row" id="">
                        <div class="form-group col-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <select name="filter_session_year_id" id="filter_rank_wise_session_year_id"
                                class="form-control">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <select name="filter_class_section_id" id="filter_rank_wise_class_section_id"
                                class="form-control">
                                ...
                                @foreach ($classSections as $classSection)
                                    <option value="{{ $classSection->id }}"
                                        data-class-id="{{ $classSection->class_id }}">{{ $classSection->full_name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table aria-describedby="mydesc" class='table' id='reank_wise_table_list'
                                ...
                                data-mobile-responsive="true" data-sort-name="percentage" data-sort-order="desc"
                                ...
                                data-query-params="getRankWiseExamResult" data-escape="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="grade" data-sortable="true">
                                            {{ __('grade') }}</th>
                                        <th scope="col" data-field="rank" data-sortable="true">
                                            {{ __('rank') }}</th>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function resetFilters() {
            ...
            const defaultSessionYear = Array.from(sessionYearSelect.options).find(option => option.getAttribute(
                'selected'));
        ...
        function updateStatistics() {
            ...
            fetch(
                    `{{ route('reports.exam.rank-wise-result-statistics') }}?session_year_id=${sessionYearId}&class_section_id=${classSectionId || ''}&subject_id=${subjectId || ''}`)
