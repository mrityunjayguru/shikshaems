                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <b>{{ __('Semester Included') }}</b> :
                                {{ $class->include_semesters ? trans('Yes') : trans('No') }}
                            </div>
                        </div>
                        <form class="pt-3 edit-class-subject-validate-form" data-success-function="formSuccessFunction"
                            ...
                            action="{{ route('class.subject.update', [$id]) }}" novalidate="novalidate">
                            <div class="modal-body">
                                <div class="form-group">
                                    <h4 title="{{ __('Core Subjects are the Compulsory Subject') }}." class="mb-3">
                                        {{ __('Core Subjects') }}<span class="fa fa-info-circle pl-2"></span></h4>
                                    <div class="core-subject-repeater">
                                                    ...
                                                    <div class="col-5 semester-div">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="semester_id" id="semester_id"
                                                                class="form-control semesters" required>
                                                                <option value="" hidden="">--
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <input type="hidden" name="class_subject_id"
                                                            class="class_subject_id" />
                                                        <label for="core_subject_id" class="d-none"></label>
                                                        <select name="id" id="core_subject_id"
                                                            class="form-control subject " required="required">
                                                            <option value="">{{ __('Select Subject') }}</option>
                                                            @foreach ($subjects as $subject)
                                                                <option value="{{ $subject->id }}">{{ $subject->name }}
                                                                    @if (!empty($subject->type) && $subject->type !== 'None')
                                                                        - {{ $subject->type }}
                                                                    @endif
                                                                </option>
                                                            @endforeach
                                        ...
                                        <div>
                                            <div class="form-group pl-0 mt-4">
                                                <button type="button" class="col-md-3 btn btn-inverse-success"
                                                    data-repeater-create>{{ __('Core Subjects') }} <i
                                    ...
                                    <h4 class="mb-4"
                                        title="{{ __('Elective Subjects are the subjects where student have the choice to select the subject from the given subjects') }}.">
                                        ...
                                        <div class="elective-subject-group-repeater col-12 col-sm-12 col-md-12">
                                            <div data-repeater-list="elective_subject_group">
                                                <div data-repeater-item class="elective-subject-group">
                                                    ...
                                                    <div class="align-items-center d-flex mb-2">
                                                        ...
                                                        <button data-repeater-delete type="button" class="btn p-0 ml-1"
                                                    ...
                                                    <div class="form-group elective-subject-repeater">
                                                        <div data-repeater-list="subject" class="mr-3 row">
                                                            <div data-repeater-item
                                                                class="elective-subject col-md-4 col-sm-12 col-12">
                                                                <div class="row">
                                                                    <div class="col-md-10 col-sm-10 col-12">
                                                                        <input type="hidden" name="class_subject_id"
                                                                            class="class_subject_id" />
                                                                        <label for="elective_id" class="d-none"></label>
                                                                        <select name="id" id="elective_id"
                                                                            class="form-control subject "
                                                                            required="required">
                                                                            <option value="" class="">
                                                                                {{ __('Select Subject') }}</option>
                                                                            @foreach ($subjects as $subject)
                                                                        ...
                                                                        <button data-repeater-delete type="button"
                                                                            class='btn p-0 remove-elective-subject'
                                                        ...
                                                        <div class="col-md-1 col-sm-12 col-12 pl-0 mt-3">
                                                            <button data-repeater-create type="button"
                                                                class="btn btn-inverse-success btn-icon add-new-elective-subject"
                                                                title="Add New Elective Subject"><i
                                                                    class="fa fa-plus"></i></button>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-12 col-sm-3">
                                                            <label
                                                                for="total_selectable_subjects">{{ __('total_selectable_subjects') }}<span
                                                                    class="text-danger">*</span></label>
                                                            <input name="total_selectable_subjects" type="text"
                                                                id="total_selectable_subjects"
                                                                placeholder="{{ __('total_selectable_subjects') }}"
                                                                class="form-control total_selectable_subjects"
                                                                min="1" max="0" data-convert="number"
                                                                required />
                                                        </div>
                                                    </div>
                                                    <hr>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-12 pl-0">
                                                <div class="form-group mt-4 col-md-4 col-sm-12 col-12 pl-0">
                                                    <button data-repeater-create type="button"
                                                        class="col-md-12 btn btn-inverse-success">{{ __('elective_subject') }}
