                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('exams.submit-marks') }}" class="create-form" id="formdata" data-success-function="formSuccessFunction">
                            ...
                            <input class="btn btn-theme float-left ml-3 px-10 py-6" id="create-btn-result" type="submit" value={{ __('submit') }} style="border-radius: 4px; min-width: 150px; background: var(--theme-color); color: white; border: 1px solid var(--theme-color); margin-bottom: 5px;">
                            </div>
                            </div>
                        </form>
                    </div>
