<div class="row">
    ...
    <div class="form-group col-sm-12 col-md-6">
        ...
        <input type="hidden" name="staff_background_image_cropped" id="staff_bg_cropped">
        <input type="file" id="staff_bg_input" class="d-none" accept="image/png,image/jpeg,image/jpg,image/webp"/>
        <div class="input-group col-xs-12">
            <input type="text" id="staff_bg_info" class="form-control file-upload-info" disabled=""
                placeholder="{{ __('image') }}" />
            <span class="input-group-append">
                <button class="btn btn-theme" type="button" onclick="document.getElementById('staff_bg_input').click()">{{ __('upload') }}</button>
            </span>
        </div>
        @if ($settings['staff_background_image'] ?? '')
            <div id="background">
                ...
                <div class="mt-2">
                    <a href="" data-type="staff_background" class="btn btn-inverse-danger btn-sm id-card-settings">
