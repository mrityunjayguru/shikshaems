                    ...
                    <div class="card-body">
                        <form class="create-form school-registration-form school-registration-validate"
                            ...
                            <input class="btn btn-secondary float-left px-10 py-6 ml-3" type="reset"
                                value={{ __('reset') }}
                                style="border-radius: 4px; min-width: 150px; background: #fff; color: var(--theme-color); border: 1px solid var(--theme-color);">

                            <input class="btn btn-theme float-left ml-3 px-10 py-6" id="create-btn" type="submit"
                                value={{ __('submit') }} {{ $email_verified == 0 ? 'disabled' : '' }}
                                style="border-radius: 4px; min-width: 150px; background: var(--theme-color); color: white; border: 1px solid var(--theme-color);">
...
@section('js')
    ...
    <script>
        function initMaps() {
            ...
            // Create map (page load)
            if (document.getElementById("map")) {
                initMap();
            }

            // ❌ DO NOT auto-init edit map here
            // editInitMap must be called only on edit click
        }
        $(document).ready(function() {
            // Initialize tooltips
        ...
        function initMap() {
            ...
            google.maps.event.addListener(marker, 'dragend', function(event) {
                ...
                fetchAddress(lat, lng, 'school_address'); // 👈 API CALL
            });
        ...
        function editInitMap() {
            ...
            google.maps.event.addListener(editmarker, 'dragend', function(event) {
                ...
                fetchAddress(lat, lng, 'edit_school_address');
            });
